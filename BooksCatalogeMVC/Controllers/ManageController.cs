    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Your password successfuly changed."
                : message == ManageMessageId.SetPasswordSuccess ? "Your Password Successfuly added"
                : message == ManageMessageId.SetTwoFactorSuccess ? "Configured provider of two-factor authentication."
                : message == ManageMessageId.Error ? "Something went wrong."
